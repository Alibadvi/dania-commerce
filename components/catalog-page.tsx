...
const categoryMap: Record<string, string> = { girl: "دخترانه", boy: "پسرانه" };

export function CatalogPage({ products, initialCategory = "all" }: { products: Product[]; initialCategory?: string }) {
  ...
  const visible = useMemo(() => {
    ...
    return filtered;
  }, [category, sort, maxPrice, products]);
