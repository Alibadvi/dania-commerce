...
export function CheckoutPage() {
  ...
  if (completed) {
    ...
    return <main className="checkout-success !bg-[#f7f1e8] [&>div]:!rounded-[32px] [&>div]:!border [&>div]:!border-[#102b49]/10 [&>div]:!shadow-[0_24px_70px_rgba(16,43,73,.1)] [&_.success-mark]:!bg-[#ffc83e] [&_.success-mark]:!text-[#102b49]"><div><span className="success-mark">✓</span><span className="eyebrow">{paid ? "سفارش با موفقیت ثبت شد" : "سفارش آماده پرداخت است"}</span><h1>ممنون! قدم‌های تازه در راه‌اند.</h1><p>شماره سفارش: <strong dir="ltr">{completed.order.code}</strong></p>{completed.paymentMode === "provider-required" && <p className="commerce-alert">برای دریافت وجه واقعی، افزونه درگاه بانکی و کلیدهای پذیرنده باید در محیط production تنظیم شوند. سفارش تا آن زمان در مرحله پرداخت باقی می‌ماند.</p>}<Link href="/shop" className="button primary">ادامه خرید</Link></div></main>;
  }

  return (
    <main className="checkout-page !bg-[#f7f1e8] !py-12 md:!py-16 [&_.checkout-heading]:!mb-8 [&_.checkout-heading_h1]:!text-[clamp(42px,6vw,72px)] [&_.checkout-heading_h1]:!tracking-[-.055em] [&_.checkout-layout]:!gap-5 [&_.checkout-form]:!gap-4 [&_.checkout-form_section]:!rounded-3xl [&_.checkout-form_section]:!border [&_.checkout-form_section]:!border-[#102b49]/[.08] [&_.checkout-form_section]:!p-5 md:[&_.checkout-form_section]:!p-7 [&_.form-section-heading>b]:!size-10 [&_.form-section-heading>b]:!bg-[#ffc83e] [&_.form-section-heading>b]:!text-[#102b49] [&_.form-section-heading_h2]:!text-lg [&_.form-grid_label]:!text-[11px] [&_.form-grid_input]:!min-h-12 [&_.form-grid_input]:!rounded-xl [&_.form-grid_input]:!border-[#102b49]/15 [&_.form-grid_textarea]:!rounded-xl [&_.form-grid_textarea]:!border-[#102b49]/15 [&_.form-grid_input:focus]:!border-[#315dff] [&_.form-grid_input:focus]:!ring-4 [&_.form-grid_input:focus]:!ring-[#315dff]/10 [&_.delivery-options_label]:!rounded-2xl [&_.delivery-options_label.active]:!border-[#315dff] [&_.delivery-options_label.active]:!bg-[#315dff]/[.05] [&_.payment-placeholder]:!rounded-2xl [&_.payment-placeholder]:!border-[#102b49]/15 [&_.checkout-submit]:!min-h-14 [&_.checkout-submit]:!rounded-full [&_.checkout-submit]:!bg-[#102b49] [&_.order-summary]:!rounded-3xl [&_.order-summary]:!border [&_.order-summary]:!border-[#102b49]/[.08] [&_.order-summary]:!p-5 md:[&_.order-summary]:!p-7 [&_.order-summary_h2]:!text-xl [&_.summary-thumb]:!rounded-xl [&_.promo-form]:!rounded-full [&_.promo-form]:!border-[#102b49]/15 [&_.promo-form_button]:!bg-[#ff6b68]">
